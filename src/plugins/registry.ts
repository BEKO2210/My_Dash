...
import { SessionTimeline, SESSION_TIMELINE_VIEWS } from "./session-timeline/widget";
...
export const widgets: Widget[] = [
  ...
  { id: "session-timeline", title: "Session-Timeline", titleKey: "timeline.title", span: "lg:col-span-3", height: H, icon: Clock, category: "sessions", description: "timeline.info", settings: [viewSetting(SESSION_TIMELINE_VIEWS)], component: SessionTimeline },
